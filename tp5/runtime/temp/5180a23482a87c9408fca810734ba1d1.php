<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:94:"/Applications/MAMP/htdocs/ThinkPHP5.0/tp5/public/../application/index/view/index/about-us.html";i:1474614892;s:93:"/Applications/MAMP/htdocs/ThinkPHP5.0/tp5/public/../application/index/view/layouts/index.html";i:1474613426;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="header-bottom">
		...
		<section>
			<div class="container">
				<div class="row">
					<div class="col-sm-7">
						<img class="img-resonsive big-img" src="../spdn_13_Emarket/images/about-us.jpg" width="650" />
					</div>
					<div class="col-sm-5">
										...
										<div class="col-sm-6">
											<li class="media">
												<div class="media-left">
													<a href="#"><img class="media-object img-circle" src="../spdn_13_Emarket/images/team-1.png" width="80" alt="..."></a>
												</div>
								...
								<div class="item active">
									<div class="row">
										<div class="col-sm-3">
											<div class="thumbnail">
												<div class="team-img">
													<img class="img-responsive" src="../spdn_13_Emarket/images/team-1.png" alt="">
							...
							<div class="row">	
								<div class="col-sm-12">
									<ul class="list-inline text-center">
										<li><img class="" src="../spdn_13_Emarket/images/1.gif" /></li>
										<li><img class="" src="../spdn_13_Emarket/images/2.png" /></li>
										<li><img class="" src="../spdn_13_Emarket/images/3.png" /></li>
										<li><img class="" src="../spdn_13_Emarket/images/4.png" /></li>
										<li><img class="" src="../spdn_13_Emarket/images/5.png" /></li>
										<li><img class="" src="../spdn_13_Emarket/images/6.png" /></li>
										<li><img class="" src="../spdn_13_Emarket/images/7.png" /></li>
										<li><img class="" src="../spdn_13_Emarket/images/8.png" /></li>
									</ul>
								</div>
							</div>
						</div>
